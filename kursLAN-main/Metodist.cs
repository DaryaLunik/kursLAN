    ...
    internal class Metodist
    {
        ...
        public void AddSpes()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                svedeniya.Add(new Specialty(id, name, special, formstudy, laboratorywork));
            }
        }
        ...
        public void GetSpec()
        {
            foreach (Specialty svedeniya in svedeniya)
            {
                Console.WriteLine($"Специальности:\nID Специальности - { svedeniya.Id}\n" +
                $"Название - { svedeniya.Name}\nСпециальность - { svedeniya.Special} \nФорма обучения - { svedeniya.Formstudy}\nЛабораторные часы - { svedeniya.Laboratorywork}");
            }
        }

        //public void PoiskLab()
        //{
        ...
        //    foreach (Specialty svedeniya in svedeniya)
        //    {
        //        if (svedeniya.Name.Equals(zapros, StringComparison.OrdinalIgnoreCase))
        //        {
        //            Console.WriteLine($"Специальность: {svedeniya.Name} — Лабораторных часов: {svedeniya.Laboratorywork}");
        //            found = true;
        //        }
        //    }
